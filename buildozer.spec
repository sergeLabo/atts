...
title = Android Treading TCP Server
...
version = 0.04
# 0.04 get ip bug, set manuel
# 0.03 reste pb latence/pile et quit et kill thread
# 0.02 ajout while pour reception
# 0.01 1er test latence
